<template>
    ...
    <footer class="bg-neutral-900 text-center text-white flex justify-center">
        <div class="container px-6 pt-6">
            ...
            <div class="mb-2 flex justify-center">
                ...
                <a href="https://www.linkedin.com/in/zach-edwards-905b105a/" type="button"
                    class="m-1 h-7 w-7 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init data-te-ripple-color="light">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor"
                        viewBox="0 0 24 24">
                ...
                <a href="https://github.com/edwardz8" type="button"
                    class="m-1 h-7 w-7 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init data-te-ripple-color="light">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-full w-4" fill="currentColor"
                        viewBox="0 0 24 24">
       ...
       <!--  <div class="p-4 text-center">
            <a class="text-white" href="#">Made with love Vue/Nuxt 3</a>
        </div> -->
    </footer>
</template>